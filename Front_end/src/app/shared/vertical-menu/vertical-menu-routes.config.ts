...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/partnership', title: 'Partnerships', icon: 'ft-book', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
  { path: '/proposal', title: 'Proposals', icon: 'ft-book', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
  { path: '/entreprise', title: 'Entreprises', icon: 'ft-book', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
  { path: '/center', title: 'Centers', icon: 'ft-book', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
